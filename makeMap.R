...
# dir
wdmain <- "C:/Users/gp44veno/Desktop/favors_for_people/j_soy_br"
setwd(wdmain)
...
br2ger <- trase[which(trase$COUNTRY == "GERMANY"),] 
...
br2eu <- trase[which(trase$ECONOMIC.BLOC == "EUROPEAN UNION"),] 
...
png(file="mysoymaps.png", width = 1000, height = 500, units="px", res = 300)
plot_grid(gmap, eumap)
dev.off()
